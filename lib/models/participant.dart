class Participant {
  ...
  Map<String, dynamic> toJson() {
    return {'id': id, 'nom': nom, 'prenom': prenom, 'grade': grade};
  }
...
class Score {
  ...
  Map<String, dynamic> toJson() {
    return {'shots': shots.map((shot) => shot.toJson()).toList()};
  }
    ...
    return Score(
      shots:
          (json['shots'] as List?)
              ?.map(
                (shotJson) =>
                    ShotRecord.fromJson(shotJson as Map<String, dynamic>),
              )
              .toList() ??
